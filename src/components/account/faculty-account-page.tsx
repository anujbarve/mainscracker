...
export default function FacultyAccountPage() {
  ...
  if (!profile) {
    return <FacultyAccountPageSkeleton />;
  }
  ...
  return (
    <main className="w-full min-h-screen p-4 sm:p-6 lg:p-8">
      <div className="mx-auto max-w-7xl grid grid-cols-1 gap-8 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Set whether you are available for new mentorship sessions and answer evaluations.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="flex items-center space-x-4 rounded-md border p-4">
                <div className="flex-1 space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Your profile will be shown to students seeking mentors and you'll receive answer evaluation assignments.
                  </p>
                </div>
                <Switch
        ...
        {/* Right Column: Account Status and Faculty Stats */}
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <StatCard
                ...
                value={profile.total_answers_evaluated || 0}
              />
              <StatCard
                icon={Users}
                label="Mentorship Sessions"
                value={profile.total_mentorship_sessions || 0}
              />
              {/* <StatCard
                icon={GraduationCap}
...
function FacultyAccountPageSkeleton() {
  return (
